...
const agendaData = [
  ...
  },
  {
    ...
    name: '水球潘',
    level: '入門',
    topic: '新創到底適不適合走 DDD ？ 就讓我公司當白老鼠走一次 Scrum x DDD 試試看吧',
    intro: '',
    content: '一直以來 DDD 都被視為是一種「更系統化」的軟體工程方法論，幫助我們釐清企業軟體設計的核心複雜度。但也因此讓許多夥伴質疑 DDD 在「新創」情境下的適用度。',
    content2: '「每一個 DDD 的例子都是有企業規模的例子，在那樣大的企業規模下，你才畫得出那些 Bounded Context 啊⋯⋯複雜度夠高你的戰術設計和領域層隔離才會有效益啊⋯⋯那這樣新創公司的話不就很不適合走 DDD？」',
    content3: '你是不是也很好奇⋯⋯',
    content4: '1. 新創公司面對這麼高頻率的試錯和需求變動，到底要怎麼帶團隊 DDD？',
    content5: '2. Scrum 和 DDD 之間要怎麼結合才會比較敏捷一些？',
    content6: '3. DDD 的本意雖然是杜絕「過度設計」，但是 DDD 本身在新創不也可能反而是「過度工程」嗎⋯⋯？',
    content7: '4. 在新創公司，領域專家到底又是何物？',
    content8: '水球我創業至今剛好一年多，我在這一年內正好就是在我司的 Product Team 中走 DDD 來迭代產品開發的。',
    content9: '就讓我來去當那隻白老鼠，我要分享我公司從 Milestone 1 課程平台，一路接收使用者回饋、每週 Release 然後迭代到 Milestone 2 開始開發 pre-seed round 教育創新產品的流程展示，並分享我針對這幾項問題的答案吧！',
    website: ''
  },
  {
    id: 'room30202',
